	...
	<script type="text/javascript">
		$(function () {
			...
			$("#updateDicTypeBtn").click(function () {
				$.ajax({
					url : "settings/dicType/updateDicType.do",
					data:{
						"id":"${dicType.code}",
					...
					success : function (data) {
						if(data.success){
							window.location.href="settings/dictionary/index.jsp"
						}else {
							alert("修改失败,请重试")
						}
					}
		...
		function show() {
			$("#edit-code").val("${dicType.code}")
			$("#edit-name").val("${dicType.name}")
			$("#edit-describe").val("${dicType.description}")
		}
	</script>
</head>
<body>
	...
	<div style="position:  relative; left: 30px;">
		<h3>修改字典类型</h3>
	  	<div style="position: relative; top: -40px; left: 70%;">
			<button type="button" class="btn btn-primary" id="updateDicTypeBtn">更新</button>
	...
	<form class="form-horizontal" role="form">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<textarea class="form-control" rows="3" id="edit-describe" style="width: 200%;"></textarea>
			</div>
		</div>
	</form>
