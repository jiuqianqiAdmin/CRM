...
<script type="text/javascript">
	$(function(){
		...
		$("#searchActivityByName").keydown(function (event) {
			//如果取得的键位的码值为13，表示敲的是回车键
			if(event.keyCode==13){
				$.ajax({
					url: "workbench/clue/searchActivityByName.do",
					data: {
						"name":$.trim($("#searchActivityByName").val())
					},
					type: "get",
					dataType: "json",
...
<body>
		...
		<div class="modal-dialog" role="document" style="width: 90%;">
			<div class="modal-content">
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询" id="searchActivityByName">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="aname">确定</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		<form id="saveTranFrom" action="workbench/clue/convert.do" method="post">
